...
public class MetricEventPublisherTest {
    private static class NullMetricEventPublisher implements MetricEventPublisher {
        ...
        private NullMetricEventPublisher(String group) {
            this.group = group;
        }

        @Override
        public Map<String, String> getDimensions(Map<String, String> extraDimensions) {
            Map<String, String> map = new HashMap<>(extraDimensions);
            map.put("qux", "norf");
            return map;
        }
    ...
    public void testGroup() {
        MetricEventPublisher publisher = new NullMetricEventPublisher("test");
        MetricEvent event = publisher.convert(null, null);
        Assert.assertEquals(event.getGroup(), "test");
    ...
    public void testPublishingEmptyMetrics() throws Exception {
        NullMetricEventPublisher publisher = new NullMetricEventPublisher("test");
