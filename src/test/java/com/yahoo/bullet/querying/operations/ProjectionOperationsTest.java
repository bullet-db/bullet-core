...
public class ProjectionOperationsTest {
    ...
    public void testDefaults() {
        ...
        BulletRecord actual = ProjectionOperations.compute(record, projection, null, provider);
    ...
    public void testProjection() {
        ...
        BulletRecord actual = ProjectionOperations.compute(box.getRecord(), projection, null, provider);
    ...
    public void testFailingProjection() {
        ...
        ProjectionOperations.compute(record, projection, null, provider);
    }
    ...
    public void testRepeatedProjections() {
        ...
        BulletRecord firstProjection = ProjectionOperations.compute(record, first, null, provider);
        BulletRecord secondProjection = ProjectionOperations.compute(record, second, null, provider);
