...
public class RESTQueryPublisher extends RESTPublisher {
    ...
    /**
     * Create a RESTQueryPublisher from a {@link CloseableHttpAsyncClient}, queryURL and resultURL. The BulletConfig must
     ...
     */
    public RESTQueryPublisher(CloseableHttpAsyncClient client, String queryURL, String resultURL) {
        super(client);
